            ...
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 10, gap: 10, }}>
                        {
                        markets.map((market) => (
                            <Pressable key={market.id} style={{ padding: 10, borderWidth: 1, borderColor: '#015115', backgroundColor: `${selectedMarket === market.name ? '#015115' : '#fff'}`, borderRadius: 25 }}
...

                    {
                            selectedMarket.trim() === 'Soweto' && (
                                <ScrollView contentContainerStyle={{ padding: 16, marginTop: 20, backgroundColor: '#ffff', borderRadius: 12 }}>
                                {
                                    crops.map((crop) => (
